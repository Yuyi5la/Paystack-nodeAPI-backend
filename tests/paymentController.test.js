...
describe('Payment API', () => {
  ...
  it('should create a payment on POST /payments', async () => {
    const res = await request(app).post('/api/v1/payments').send({
    ...
    paymentId = res.body.payment.id;  // save for next test
  });

  it('should get payment status on GET /payments/:id', async () => {
